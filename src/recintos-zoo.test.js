...
describe('Recintos do Zoologico', () => {
	...
	test('Não deve achar recinto disponível para leopardo', () => {
	...
	// Passei como parâmetro leao minúsculo para demonstrar que fiz a formatação da string na função para padronização, ou seja, pouco importa passar minúsculo ou maiúsculo, evitando erros durante a execução
